...
namespace RoboJarvis.Comp.Motion.Pages
{
    public partial class MotionHeaderPanel : ViewPage
    {
        ...
        void _axis_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            {
                kbtnEnable.Text = _axis.AxisEnabled ? "Disable" : "Enable";
            }
        }
        ...
        private void kbtnEnable_Click(object sender, EventArgs e)
        {
            kbtnEnable.Enabled = false;
            try
            {
            ...
            {
                kbtnEnable.Enabled = true;
            }
        }

        private void kbtnHome_Click(object sender, EventArgs e)
        {
            kbtnHome.RunAsync(() => _axis.MoveHome());
        }
    }
}
