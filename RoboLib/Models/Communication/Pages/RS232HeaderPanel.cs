...
namespace RoboLib.Models.Communication.Pages
{
    public partial class RS232HeaderPanel : ViewPage
    {
        ...
        void _rs232_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            {
                kbtnConnect.Text = _rs232.Connected ? "Disconnect" : "Connect";
                kbtnSend.Enabled = _rs232.Connected;
            }
        }

        private void kbtnHelp_Click(object sender, EventArgs e)
        {
        ...
        private void kbtnSend_Click(object sender, EventArgs e)
        {
